...
GREETING = 'Снова привет, {name}! Я помогу вам всегда знать своё расписание! Если вы хотите узнать команды, то скажите мне "Помощь".'
NEW_CREATE_PROFILE = {
...
COMPLETE_SETTINGS = 'Настройка завершена! Если вы захотите изменить данные, скажите мне "Настроить профиль". Чтобы узнать команды, так и скажите мне "Помощь"'
HELP = 'Я могу вам сказать ваше расписание на сегодня, завтра или даже через несколько дней! Но для начала вам нужно настроить свой аккаунт, чтобы я знала какое у вас расписани!'
COMMANDS = '''- Чтобы узнать какая пара идёт сейчас, скажите "Пара сейчас" или "Сейчас"
...
- Чтобы узнать доступные команды, скажите мне "Помощь"
'''
